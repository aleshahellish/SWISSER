...
Сервер продолжает отдавать прежний URI шаблона, чтобы уже установленные
экземпляры SWISSER не теряли интерфейс после обновления.
Интерфейс панели монохромный и компактный: короткие подписи видимы пользователю,
а кнопки по-прежнему отправляют полные рыночные команды.
