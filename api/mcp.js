...
const CONTROLS_URI = "ui://swisser/market-controls/1.9.1.html";
...
export function createSwisserMcpServer() {
  const server = new McpServer({
    ...
    instructions:
      ...
      "инвалидацию, затем дай статус ВХОД ПОДТВЕРЖДЁН, ЖДАТЬ или ОТМЕНА. Если предыдущего списка нет, " +
