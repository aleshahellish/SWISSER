...
def request_json(path: str, params: dict | None = None):
    ...
    for attempt in range(3):
        ...
        request = urllib.request.Request(
            url,
            headers={
                "User-Agent": "Mozilla/5.0 MEXC-Enhanced-Scanner-V5/1.0",
...
def protected_break_events(
    ...
    if latest and latest["direction"] == "BULLISH":
        active_directional = active_protected_low
    elif latest and latest["direction"] == "BEARISH":
        active_directional = active_protected_high
    else:
    ...
    return {
        ...
        "current_protected_low": active_protected_low,
        "current_protected_high": active_protected_high,
...
def build(path: str) -> dict:
    ...
    return {
        ...
        "mode": "enhanced_multi_coin_scanner_v5",
        "version": "5.0-protected-levels-cisd",
        "fetched_at_unix": now,
